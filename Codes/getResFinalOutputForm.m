...
%     ResStat.mean{'scalar',1} = {m_tb};   ResStat.mean{'scalar','is_scalar'}  = 1  ; 
%     ResStat.std{'scalar',1}  = {std_tb}; ResStat.std{'scalar','is_scalar'}  = 1  ; 
%     ResStat.mean{'scalar',:} = {m_tb, 'scalar','all', 1};   
%     ResStat.std{'scalar',:}  = {std_tb, 'scalar','all', 1}; 
